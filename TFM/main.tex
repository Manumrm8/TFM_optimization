...
Hasta donde sabemos, sólo existen dos artículos previos en este problema. En el primero de ellos, \cite{k-balanced_1} propone el problema, actualizándo el clásico de k-centros introduciendo que se busque balancear las cargas de las instalaciones.
...
Como se observa en la Figura~\ref{fig:casos_ejemplo}. La Figura~\ref{fig:poblacion_centros_medicos} muestra la distribución inicial, con 400 puntos azules representando a la población y 20 puntos verdes para las posibles localizaciones de los centros.

A continuación, se evalúan tres soluciones de ejemplo. Una primera solución aleatoria (Figura~\ref{fig:ejemplo_1}) resulta en una mala cobertura, ya que al escogerse centros por el sur y oeste, gran parte de Valencia queda con un acceso deficiente. Una segunda aproximación (Figura~\ref{fig:ejemplo_2}) mejora la distribución, pero sigue presentando desequilibrios: zonas del norte y sur permanecen alejadas y algunos centros podrían sobresaturarse mientras otros, como el del extremo oeste, tendrían poco uso. Finalmente, la solución de la Figura~\ref{fig:ejemplo_3} ofrece una dispersión más equilibrada y es la que mejor apariencia tiene de las tres, dejando solo la zona sur del puerto más desatendida.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Ejemplo de solución aleatoria.}
        \label{fig:ejemplo_1}
    \end{subfigure}
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Tercer ejemplo de solución (mejorada).}
        \label{fig:ejemplo_3}
    \end{subfigure}
...
\color{red} cambiar las figuras utilizando el workspace 1000 50 5 \color{black}
...
\begin{thebibliography}{X}
    ...
    vol. 6, no. 2, pp. 109--133, 1995.

    \bibitem{oscillation}
    F. Glover and J.-K. Hao,
    "The case for strategic oscillation,"
    \textit{Annals of Operations Research},
    vol. 183, pp. 163--173, Mar. 2011.

    \bibitem{path_relinking}
    R. Mart\'i, F. Glover and M. Laguna,
    "Scatter search and path-relinking: Fundamentals, advances, and applications,"
    in \textit{Handbook of Metaheuristics}, M. Gendreau and J-Y. Potvin, Eds., Springer, 2010, pp. 1--27.
