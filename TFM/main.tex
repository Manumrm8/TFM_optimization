...
El \textbf{Problema de Localización Multiobjetivo de K-Centros Balanceado} consiste en seleccionar, de un conjunto de $m$ posibles centros, los $k$ que mejoren sus funciones objetivo \color{red} No se si enunciar aquí ya las funciones objetivo o dejarlas para el modelo.  \color{black}. El número total de posibles soluciones es finito, y viene dado por el coeficiente binomial 
